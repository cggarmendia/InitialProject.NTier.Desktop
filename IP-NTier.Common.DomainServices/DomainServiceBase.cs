        ...
        where TEntity : class, IEntity
    {
        ...
        protected IRepository<TEntity> repository
        {
            get
            {
                ...
                if (!callContext.Contains(IpNTierKeyConst.UoW) || callContext.Retrieve<IUnitOfWork>(IpNTierKeyConst.UoW) == null)
                    throw new Exception("Unit of Work not generated or already closed");

                IUnitOfWork uow = callContext.Retrieve<IUnitOfWork>(IpNTierKeyConst.UoW);
